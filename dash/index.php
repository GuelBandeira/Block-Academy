...
<head>
    ...
    <link rel="stylesheet" href="<?= SITE_URL ?>assets/css/libs.min.css">
        ...
        <div class="page-content">
            <aside class="sidebar is-show" id="sidebar">
                <div class="sidebar-box">
                    <ul class="uk-nav">
                        <li class="uk-active"><a href="03_home.html"></a><i class="ico_home"></i><span>Home</span></a></li>
                        <li class="uk-nav-header">Principal</li>

                        <li><a href="05_favourites.html"><i class="ico_favourites"></i><span>Compartilhe e
            ...
            <main class="page-main">
                <div class="uk-grid" data-uk-grid>
                    <div class="uk-width-2-3@xl">
                        <h3 class="uk-text-lead">Novidades</h3>
                                        ...
                                        <div class="recommend-slide">
                                            <div class="recommend-slide__box">
                                                <div class="recommend-slide__info">
                                                    <div class="recommend-slide__logo"><img src="<?= SITE_URL ?>assets/img/recommend-slide-logo.png" alt="logo"></div>
                                                    <div class="recommend-slide__intro"><span>Ghostrunner offers a
                                                            unique single-player experience: fast-paced and violent
                                                            combat.</span></div>
                                                    ...
                                                    <div class="recommend-slide__btn"><button class="uk-button uk-button-danger" type="button">Play
                                                            Now</button></div>
                                                ...
                                                <div class="recommend-slide__img"><img src="<?= SITE_URL ?>assets/img/recommend-slide-img.png" alt="image"></div>
                                                <div class="recommend-slide__favorites"><i class="ico_favourites"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="uk-width-1-3@xl">
                        <h3 class="uk-text-lead">Cursos grátis</h3>
                                        ...
                                        <div class="game-card --horizontal">
                                            <div class="game-card__box">
                                                <div class="game-card__media">
                                                    <a href="10_game-profile.html"><img src="<?= SITE_URL ?>assets/img/trending.jpg" alt="Warframe" /></a>
                                                </div>
                                                <div class="game-card__info"><a class="game-card__title" href="10_game-profile.html"> Warframe</a>
                    ...
                    <div class="uk-width-1-1">
                        <h3 class="uk-text-lead">Populares na Block</h3>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="game-card">
                                            <div class="game-card__box">
                                                <div class="game-card__media">
                                                    <a href="10_game-profile.html"><img src="<?= SITE_URL ?>assets/img/game-1.jpg" alt="Hell is other demons" /></a>
                                                </div>
                                                <div class="game-card__info"><a class="game-card__title" href="10_game-profile.html"> Hell is other demons</a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="game-card">
                                            <div class="game-card__box">
                                                <div class="game-card__media">
                                                    <a href="10_game-profile.html"><img src="<?= SITE_URL ?>assets/img/game-1.jpg" alt="Curse of the Dead Gods" /></a>
                                                </div>
                                                <div class="game-card__info"><a class="game-card__title" href="10_game-profile.html"> Curse of the Dead Gods</a>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="game-card">
                                            <div class="game-card__box">
                                                <div class="game-card__media">
                                                    <a href="10_game-profile.html"><img src="<?= SITE_URL ?>assets/img/game-1.jpg" alt="Frostpunk" /></a>
                                                </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="game-card">
                                            <div class="game-card__box">
                                                <div class="game-card__media">
                                                    <a href="10_game-profile.html"><img src="<?= SITE_URL ?>assets/img/game-1.jpg" alt="A Total War Saga: TROY" /></a>
                                                </div>
                ...
                <form class="uk-form-stacked" action="#">
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls uk-margin-small-top">
                            <div data-uk-form-custom><input type="file"><button class="uk-button uk-button-default" type="button" tabindex="-1"><i class="ico_attach-circle"></i><span>Attach
        ...
        <div class="uk-flex-top" id="modal-help" data-uk-modal>
            <div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical"><button class="uk-modal-close-default" type="button" data-uk-close></button>
                ...
                <div class="uk-margin-small-left uk-margin-small-bottom uk-margin-medium-top">
                    <h4>Popular Q&A</h4>
                    <ul>
                        <li><img src="<?= SITE_URL ?>assets/img/svgico/clipboard-text.svg" alt="icon"><span>How to Upload Your
                                Developed Game</span></li>
                        <li><img src="<?= SITE_URL ?>assets/img/svgico/clipboard-text.svg" alt="icon"><span>How to Go Live
                                Stream</span></li>
                        <li><img src="<?= SITE_URL ?>assets/img/svgico/clipboard-text.svg" alt="icon"><span>Get in touch with the
